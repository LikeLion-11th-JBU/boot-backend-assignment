...
import dev.SeungIL.community.model.MediaDescriptorDto;
import dev.SeungIL.community.service.MediaService;
...
//        Path newFilePath = Path.of(String.valueOf(Path.of(basePath, file.getOriginalFilename())));
//        try{
